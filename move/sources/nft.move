...
module my_addrx::NFT {
    ...
    const COLLECTION_NAME: vector<u8> = b"MoveAi";
    const COLLECTION_DESCRIPTION: vector<u8> = b"Say MoveAi!";
    const COLLECTION_URI: vector<u8> = b"https://pbs.twimg.com/profile_images/1744477796301496320/z7AIB7_W_400x400.jpg";
    const TOKEN_DESCRIPTION: vector<u8> = b"MoveAi early users token";
